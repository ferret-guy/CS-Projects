...
public class Proj11
{
        public static void main(String[] args)
        {
                ...
                while (true)
                {
                        ...
                        // see if we can colapse anything.
                        ...
                        else
                        {
                                ...
                                StdDraw.show(10);   // pause, so that we don't flood the user with messages.
                                continue;
                        }
                        ...
                        board.addOne();
                        if (Math.random() < .25)
                                board.addOne();   // it's OK if this one didn't fit...that won't end the game.
